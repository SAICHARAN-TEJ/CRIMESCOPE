...
// Shell states (visual only — controller timing untouched)
  ...
  <div class="console" id="crimescope-app-demo">
    ...
    <nav class="console__nav" aria-label="Demo Console Navigation">
      ...
      <div class="console__nav-right">
        ...
        <span class="stage-state-chip mono" :class="pipelineSummary.cls">{{ pipelineSummary.label }}</span>
      </div>
    </nav>
    ...
    <div class="console__body">
      ...
      <main class="console__center">
        ...
        <!-- Shell acknowledges global run state above the surface. -->
